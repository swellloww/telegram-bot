...
def auto_approve_and_welcome(client, request: ChatJoinRequest):
    try:
        client.approve_chat_join_request(request.chat.id, request.from_user.id)

        welcome_message = """👋 Hey there, Trader!
...
🔗 https://t.me/+LCqPFEoYMqJjZDQ1
"""
        client.send_message(request.chat.id, welcome_message)

    except Exception as e:
        print("❌ Could not approve or send welcome message:", e)
